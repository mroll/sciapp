...
namespace eval ::box {
    ...
    proc get { url args } {
        ...
        if { [dict exists $args class] } {
            ...
            dict unset args class
        }
        set txt [dict get $args text]
        dict unset args text
    ...
    set litem_defaults { text {} class {} }
    widget litem $litem_defaults { id args } {
        dict with args {}
        
        set html [<span> id $id class "list-group-item list-text $class" \
                      style "border-radius: 0;" $text]
    ...
    widget boxgroups $boxgroup_defaults { id args } {
        ...
        foreach group $groups label $labels {
            ...
            lappend md [litem ${label}group text $label class list-group-item-action cb $callback]
